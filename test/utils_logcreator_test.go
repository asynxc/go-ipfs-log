...
func createLogsFor16Entries(ctx context.Context, ipfs format.DAGService, identities []*idp.Identity) (*ipfslog.IPFSLog, error) {
...
func CreateLogWithSixteenEntries(ctx context.Context, ipfs format.DAGService, identities []*idp.Identity) (*CreatedLog, error) {
	expectedData := []string{
...
func createLogWithHundredEntries(ctx context.Context, ipfs format.DAGService, identities []*idp.Identity) (*ipfslog.IPFSLog, []string, error) {
...
func CreateLogWithHundredEntries(ctx context.Context, ipfs format.DAGService, identities []*idp.Identity) (*CreatedLog, error) {
