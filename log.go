...
func NewLog(services format.DAGService, identity *identityprovider.Identity, options *LogOptions) (*IPFSLog, error) {
	if services == nil {
...
func NewFromMultihash(ctx context.Context, services format.DAGService, identity *identityprovider.Identity, hash cid.Cid, logOptions *LogOptions, fetchOptions *FetchOptions) (*IPFSLog, error) {
	if services == nil {
		return nil, errmsg.ErrIPFSNotDefined
	}
...
//
// Creating a log from a hash will retrieve entries from IPFS, thus causing side effects
func NewFromEntryHash(ctx context.Context, services format.DAGService, identity *identityprovider.Identity, hash cid.Cid, logOptions *LogOptions, fetchOptions *FetchOptions) (*IPFSLog, error) {
	if logOptions == nil {
		return nil, errmsg.ErrLogOptionsNotDefined
	}
...
func NewFromJSON(ctx context.Context, services format.DAGService, identity *identityprovider.Identity, jsonLog *iface.JSONLog, logOptions *LogOptions, fetchOptions *entry.FetchOptions) (*IPFSLog, error) {
	if logOptions == nil {
		return nil, errmsg.ErrLogOptionsNotDefined
	}
...
func NewFromEntry(ctx context.Context, services format.DAGService, identity *identityprovider.Identity, sourceEntries []iface.IPFSLogEntry, logOptions *LogOptions, fetchOptions *entry.FetchOptions) (*IPFSLog, error) {
	if logOptions == nil {
		return nil, errmsg.ErrLogOptionsNotDefined
	}
